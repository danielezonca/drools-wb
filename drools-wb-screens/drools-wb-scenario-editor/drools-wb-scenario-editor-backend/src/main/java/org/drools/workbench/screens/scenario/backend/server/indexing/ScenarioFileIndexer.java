 ...
 */
package org.drools.workbench.screens.scenario.backend.server.indexing;
...
@ApplicationScoped
public class ScenarioFileIndexer extends AbstractDrlFileIndexer {

    @Inject
    private DataModelService dataModelService;

    @Inject
    protected ScenarioResourceTypeDefinition type;

...
package org.drools.workbench.screens.scenario.model;
...
@Portable
public class ScenarioEditorContent {

    private ScenarioModel model;
    private List<String> fullyQualifiedClassNames;
    private Overview overview;

    public ScenarioEditorContent() {
    }

    public ScenarioEditorContent(final ScenarioModel model,

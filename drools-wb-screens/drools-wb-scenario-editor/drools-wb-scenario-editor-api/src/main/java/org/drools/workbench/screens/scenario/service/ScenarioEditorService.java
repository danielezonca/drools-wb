...
package org.drools.workbench.screens.scenario.service;
...
public interface ScenarioEditorService
        extends
        ViewSourceService<ScenarioModel>,
        ValidationService<ScenarioModel>,
        SupportsCreate<ScenarioModel>,
        SupportsRead<ScenarioModel>,
        SupportsSaveAndRename<ScenarioModel, Metadata>,
        SupportsDelete,
        SupportsCopy {

    ScenarioEditorContent loadContent(final Path path);

...
@Dependent
public class AddScenarioCommandPopup implements AddScenarioCommandPopupView.Presenter {

    private AddScenarioCommandPopupView view;
    ...
    @Inject
    public AddScenarioCommandPopup(final AddScenarioCommandPopupView view) {
        this.view = view;
    }
